...
impl World {
    ...
    // its not safe but its ussaly use for interoperability between languages like in wasm exemple
    ...
    // pub fn snake_cells_v2(&self) -> Vec<SnakeCell> {
    //     let mut body = vec![];
    //     body.clone_from_slice(&self.snake.body);
    //     body
    // }
